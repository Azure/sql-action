...
Azure SQL Action for GitHub is supported on 'AzureUSGovernment' .Login to the respective Azure Cloud before this using [Azure Login](https://github.com/Azure/login)
