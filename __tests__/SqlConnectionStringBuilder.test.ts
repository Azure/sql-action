...
describe('SqlConnectionStringBuilder tests', () => {
    ...
    describe('validate correct connection strings', () => {
        let validConnectionStrings = [
            ...
            [`User Id=user;Password=JustANormal123@#$password;Server=test1.database.windows.net;Initial catalog=testdb`, 'validates values not beginning quotes and not containing quotes or semi-colon', `JustANormal123@#$password`]
        ];
