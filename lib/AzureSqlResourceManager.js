...
const AzureRestClient_1 = require("./Webclient/AzureRestClient");
class AzureSqlResourceManager {
    constructor(resourceAuthorizer) {
        ...
        this._restClient = new AzureRestClient_1.AzureRestClient(resourceAuthorizer);
    }
...
exports.AzureSqlResourceManager = AzureSqlResourceManager;
