...
export default async function run() {
    ...
    try {
        ...
        if (runnerIPAddress) {
            ...
            let azureSqlResourceManager = await AzureSqlResourceManager.getResourceManager(inputs.connectionConfig.ParsedConnectionString.server, azureResourceAuthorizer);
